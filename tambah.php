                        ...
                        <?php if ($result->num_rows > 0) : ?>
                            <?php while ($barang_data = mysqli_fetch_assoc($result)) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $barang_data['jumlah_barang'] ?></td>                                    
                                    <td>
                                        <a href="edit.php?id_barang=<?php echo $barang_data['id_barang']; ?>" class="btn btn-primary">Edit</a>
                                        <a href="delete.php?id_barang c=<?php echo $barang_data['id_barang']; ?>" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else : ?>
